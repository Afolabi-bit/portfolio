...
const Static = () => {
	return (
		<section
			...
			className=" h-screen bg-[var(--dark-bg-primary)] left-0 top-0 z-50 absolute overflow-hidden py-[60px] pl-[80px] flex flex-col justify-between 4xl:pl-[150px] 4xl:py-[150px]"
		>
			{/* Hero section */}
			<div>
